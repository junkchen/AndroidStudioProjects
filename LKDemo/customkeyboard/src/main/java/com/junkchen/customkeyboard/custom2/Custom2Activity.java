package com.junkchen.customkeyboard.custom2;
...
public class Custom2Activity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        etInputNumBuy = (EditText) findViewById(R.id.et_input_num_buy);
        etInputNumSell = (EditText) findViewById(R.id.et_input_num_sell);
        optContainer = (LinearLayout) findViewById(R.id.layout_opt_container);
        underView = (View) findViewById(R.id.view_under);
