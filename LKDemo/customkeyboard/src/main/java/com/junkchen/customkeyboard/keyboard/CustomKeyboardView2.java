...
public class CustomKeyboardView2 extends KeyboardView {
    private static final String TAG = CustomKeyboardView2.class.getSimpleName();
    ...
    public CustomKeyboardView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomKeyboardView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public CustomKeyboardView2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
