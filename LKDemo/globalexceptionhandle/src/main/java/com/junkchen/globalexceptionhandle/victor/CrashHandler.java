package com.junkchen.globalexceptionhandle.victor;
...
import com.junkchen.globalexceptionhandle.JunkApplication;
import com.junkchen.globalexceptionhandle.MainActivity;
...
public class CrashHandler implements UncaughtExceptionHandler {
     ...
     * @Description: 初始化
     */
    public void init(Context context, JunkApplication app) {
        // 传入app对象，为完美终止app
        this.app = app;
        mContext = context;
...
//            AppActivityManager.getAppActivityManager().AppExit(mContext);
    ...
    private boolean handleException(Throwable ex) {
        Log.i(TAG, "handleException: ----------有异常了----------");
        if (ex == null) {
            return false;
        }
        // 收集设备参数信息
        ...
        Log.i(TAG, "handleException: --------处理过了---------");
        return true;
    }
