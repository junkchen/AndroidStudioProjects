...
//    private TypeButton btn_cancel;          //取消按钮
    ...
    private void initView() {
        ...
        int marginSpace = (int) dpToPx(mContext, 24);
        //取消按钮
//        btn_cancel = new TypeButton(getContext(), TypeButton.TYPE_CANCEL, button_size);
        btn_cancel = new ImageView(mContext);
        btn_cancel.setImageResource(R.drawable.ic_photo_capture_cancel);
        final LayoutParams btn_cancel_param = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
        btn_cancel_param.gravity = Gravity.CENTER_VERTICAL;
//        btn_cancel_param.setMargins((layout_width / 4) - button_size / 2, 0, 0, 0);
        btn_cancel_param.setMargins(marginSpace, 0, 0, 0);
...
//        btn_confirm = new TypeButton(getContext(), TypeButton.TYPE_CONFIRM, button_size);
        btn_confirm = new ImageView(mContext);
        btn_confirm.setImageResource(R.drawable.ic_photo_capture_ok);
        LayoutParams btn_confirm_param = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
...
//        btn_confirm_param.setMargins(0, 0, (layout_width / 4) - button_size / 2, 0);
        btn_confirm_param.setMargins(0, 0, marginSpace, 0);
...
//                resetCaptureLayout();
        ...
        txt_tip.setLayoutParams(txtParam);
...
//            btn_return.setVisibility(INVISIBLE);  // 返回按钮
        }
        if (this.iconRight != 0) {
